...
def main():
    ...
    parser.add_argument("--safety_check", action="store_true", default=False,
                        help="Run safety checks on generated images (disabled by default)")
    ...
    parser.set_defaults(do_optimize_prompt=True, fix_outfit=False, safety_check=False, face_enhance=False)
